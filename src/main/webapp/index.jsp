...
<header class="Hui-header cl"> <a class="Hui-logo l" title="H-ui.admin v2.3" href="/">H-ui.admin</a> <a class="Hui-logo-m l" href="/" title="H-ui.admin">H-ui</a> <span class="Hui-subtitle l">V2.3</span>
	...
	<ul class="Hui-userbar">
		<li>${contro.contro }</li>
		<li class="dropDown dropDown_hover"><a href="#" class="dropDown_A">${contro.controname } <i class="Hui-iconfont">&#xe6d5;</i></a>
			<ul class="dropDown-menu radius box-shadow">
				<li><a href="#">个人信息</a></li>
				<li><a href="#">切换账户</a></li>
				<li><a href="#">退出</a></li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="queryForStudentList" href="javascript:void(0)">学生列表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-picture">
